...
VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(
    ...
    // 第十三阶段开始创建纹理 Image 和 Sampler，图像布局转换与描述符绑定的问题很适合交给验证层提醒。
...
private:
    ...
    void initWindow() {
        ...
        window_ = glfwCreateWindow(windowWidth, windowHeight, "Learn Vulkan - Texture", nullptr, nullptr);
        if (window_ == nullptr) {
    ...
    void createInstance() {
        ...
        appInfo.pApplicationName = "Learn Vulkan Texture";
    ...
    void createGraphicsPipeline() {
        ...
        // 第十三阶段把 Uniform Buffer 和纹理采样器的 Descriptor Set Layout 接入管线布局。
