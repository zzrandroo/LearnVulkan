...
VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(
    ...
    // 第十一阶段开始使用 Staging Buffer 和 Index Buffer，资源拷贝和索引绘制的问题很适合交给验证层提醒。
...
private:
    ...
    void initWindow() {
        ...
        window_ = glfwCreateWindow(windowWidth, windowHeight, "Learn Vulkan - Staging Index Buffer", nullptr, nullptr);
        if (window_ == nullptr) {
    ...
    void createInstance() {
        ...
        appInfo.pApplicationName = "Learn Vulkan Staging Index Buffer";
    ...
    void pickPhysicalDevice() {
        ...
        // 第十一阶段仍然需要交换链作为每帧呈现目标，因此设备必须支持 VK_KHR_swapchain 扩展和可用的 Surface 配置。
