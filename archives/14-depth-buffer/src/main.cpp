...
constexpr std::array vertices = {
    Vertex{{0.0F, -0.5F}, {1.0F, 1.0F, 1.0F}, {0.5F, 1.0F}},
...
VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(
    ...
    // 第十四阶段开始创建深度缓冲，深度格式、附件布局和 Framebuffer 绑定问题很适合交给验证层提醒。
...
private:
    ...
    void initWindow() {
        ...
        window_ = glfwCreateWindow(windowWidth, windowHeight, "Learn Vulkan - Depth Buffer", nullptr, nullptr);
        if (window_ == nullptr) {
    ...
    void createInstance() {
        ...
        appInfo.pApplicationName = "Learn Vulkan Depth Buffer";
    ...
    void createGraphicsPipeline() {
        ...
        // 第十四阶段继续使用 Uniform Buffer 和纹理采样器的 Descriptor Set Layout。
